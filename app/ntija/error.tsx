...
export default function NtijaError({
  error,
  reset
}: {
  ...
  return (
    <Sa7ebtiRouteStatus
      badge="ghalta fel ntiija"
      title="screen ntiija ma t7alletch kif lezem."
      description={error.message || "saret ghalta wa9t chargement products mscannyin."}
      tone="error"
      action={
        <button
          type="button"
