...
export function GoogleMark(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        d="M21.8 12.22c0-.74-.06-1.29-.2-1.87H12v3.54h5.64c-.11.88-.72 2.2-2.08 3.09l-.02.12 3.03 2.3.21.02c1.93-1.74 3.02-4.3 3.02-7.2Z"
        fill="#4285F4"
      />
      <path
        d="M12 22c2.76 0 5.07-.88 6.76-2.39l-3.22-2.44c-.86.59-2.01 1.01-3.54 1.01-2.7 0-4.99-1.74-5.81-4.15l-.12.01-3.15 2.39-.04.11A10.23 10.23 0 0 0 12 22Z"
        fill="#34A853"
      />
      <path
        d="M6.19 14.03A6.07 6.07 0 0 1 5.85 12c0-.71.12-1.4.32-2.03l-.01-.14-3.19-2.43-.11.05A9.73 9.73 0 0 0 1.8 12c0 1.56.38 3.04 1.06 4.38l3.33-2.35Z"
        fill="#FBBC05"
      />
      <path
        d="M12 5.82c1.92 0 3.21.81 3.95 1.49l2.89-2.75C17.06 2.99 14.76 2 12 2A10.23 10.23 0 0 0 2.86 7.62l3.31 2.52C7 7.73 9.3 5.82 12 5.82Z"
        fill="#EA4335"
      />
    </svg>
  );
